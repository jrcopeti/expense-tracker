...
/** Pure - no side effects, so every preview and the real export use the exact same selection. */
...
export const RANGE_PRESETS: Array<{ id: "7d" | "30d" | "90d" | "month" | "year" | "all"; label: string }> = [
